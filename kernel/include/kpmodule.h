...
// Define maximum lengths for module metadata
...
// Macro to define module information with a static assertion
...
// Macros for defining module metadata
...
// Macros for registering module callbacks
#define KPM_INIT(fn) \
